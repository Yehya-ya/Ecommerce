                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td class="text-bold-500">{{ ($category->created_at) ? $category->updated_at->diffForHumans() : '' }}</td>
                                    <td class="text-bold-500">{{ ($category->updated_at) ? $category->updated_at->diffForHumans() : '' }}</td>
                                    <td class="text-bold-500">
                                        <a href="{{ route('admin.category.edit', ['category' => $category]) }}" class="btn btn-primary rounded-pill">
